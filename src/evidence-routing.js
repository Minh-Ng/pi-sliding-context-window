...
export const EVIDENCE_ROUTING_GUIDELINES = Object.freeze([
  ...
  "A continuity marker establishes only that eligible earlier discussion matched the quoted anchor copied from the current user message. If prior project-specific meaning is material, run context_window_search with that exact anchor before answering; do not treat the marker itself as a recovered fact, decision, definition, or current-state claim.",
